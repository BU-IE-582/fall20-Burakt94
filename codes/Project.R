...
library(ranger)
library(glmnet)
full_data = read.csv("/home/burak/Desktop/Lectures/IE582/Project/IE582_Fall20_ProjectTrain.csv")
full_test = read.csv("/home/burak/Desktop/Lectures/IE582/Project/IE582_Fall20_ProjectTest.csv")

source("/home/burak/Desktop/Lectures/IE582/Project/example_submission.r")
setDT(full_data)
setDT(full_test)

# ExpData(data=full_data,type=1)
# SmartEDA::ExpReport(full_data,Target="y",op_file = "deneme.html",op_dir = "/home/burak/Desktop/Lectures/IE582/Project/",label = "y",Rc = "a")
